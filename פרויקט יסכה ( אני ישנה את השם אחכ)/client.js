            ...
            if(this.status === 200){
                ...
                if(contacts!==[]){
                    for(let i=0; i < contacts.length; i++){
                        ...
                        listItem.setAttribute("name", 'task');
...
function handleUpdate(ev){
    ...
    xhttp.onreadystatechange = function() {
        if(this.readyState == 4){
            if(this.status == 200){
                let myContact = this.responseText;
                //let myContact=new contact('0501111111', 'avigail', 'uzan', 'au@gmail.com');
...
function sendForAdding(ev){
    let name_elm = document.getElementById("add_first_name");
    let description_elm = document.getElementById("add_last_name");
    /*let phone_elem = document.getElementById("add_phone");*/
    /*let finished = document.getElementById("add_mail");*/
    /*let name = name_elm.value;
    let description = description_elm.value;*/
    /*let mail = finished.value;*/
    if(name_elm.value && description_elm.value/*ln && phone && mail*/){
        let new_task = new task( name_elm.value, description_elm.value /*ln, mail*/);
